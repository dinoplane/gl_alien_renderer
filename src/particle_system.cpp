...
>::UnbindBuffers() const {
    ...
    glBindBufferBase(GL_SHADER_STORAGE_BUFFER, PARTICLE_EDGE_DATA_SSBO_BINDING, 0);
    glBindBufferBase(GL_SHADER_STORAGE_BUFFER, PARTICLE_HINGE_DATA_SSBO_BINDING, 0);
    glBindBufferBase(GL_UNIFORM_BUFFER, PICKED_DATA_UBO_BINDING, 0);
    glBindBufferBase(GL_SHADER_STORAGE_BUFFER, PARTICLE_FIXED_NODES_SSBO_BINDING, 0);
    glBindBufferBase(GL_SHADER_STORAGE_BUFFER, PARTICLE_TEXCOORDS_SSBO_BINDING, 0);
